              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text("❝", style: TextStyle(color: Color(0xFFFF9001), fontSize: 26, fontWeight: FontWeight.bold)),
                      SizedBox(width: 6.w),
                      Expanded(
                        child: Text(
                          quote,
                          style: AppTypography.sectionTitle.copyWith(fontSize: 14.5.sp, color: Colors.black87, height: 1.35),
