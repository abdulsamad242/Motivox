...
class FamilyGratitudePage extends StatefulWidget {
  const FamilyGratitudePage({super.key});

  @override
  State<FamilyGratitudePage> createState() => _FamilyGratitudePageState();
}

class _FamilyGratitudePageState extends State<FamilyGratitudePage> {
  ...
  return Padding(
    ...
    child: ConstrainedBox(
      constraints: BoxConstraints(
        maxHeight: MediaQuery.of(context).size.height * 0.55, // LIMIT HEIGHT
      ),
                ...
                child: Center(
                  child: Text(
                    ...
                    style: AppTypography.bodyMedium.copyWith(
                      fontSize: 17,
                      color: isSelected
                          ? const Color.fromRGBO(255, 134, 31, 1)
                          : Colors.white,
                      fontWeight:
          ...
          children: [
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText:
                                  "List 5 things you love or appreciate about your family.",
                      ...
                      return AlertDialog(
                        ...
                        content: TextField(
                          ...
                          decoration: const InputDecoration(
                            hintText: "Update your gratitude line",
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color.fromRGBO(255, 134, 31, 1),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(14),
                  ),
                ),
...
// ---------------- GLASS GRATITUDE CARD ------------------
class _FamilyGlassCard extends StatelessWidget {
  final String text;
  final VoidCallback onEdit;
  final VoidCallback onDelete;

  const _FamilyGlassCard({
    super.key,
    required this.text,
