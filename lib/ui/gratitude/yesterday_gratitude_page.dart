...
class YesterdaysGratitudePage extends StatefulWidget {
  ...
  @override
  State<YesterdaysGratitudePage> createState() => _YesterdaysGratitudePageState();
}
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        "Looking Back with Gratitude Reflect on the moments\nthat made yesterday meaningful.",
                        style: TextStyle(
              ...
              // Calendar day slider (in its own container!)
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: isSelected ? const Color(0xFF245CF2) : Colors.white.withOpacity(0.11),
              ...
              // Multiline Input Box with Pencil Icon
Container(
  // No need for fixed height; let minLines control it
      ...
      Expanded(
        child: TextField(
          ...
          decoration: const InputDecoration(
            ...
            // Don't add big vertical padding for multi-line!
