...
class _ExerciseScreenState extends State<ExerciseScreen> {
  ...
  // --- Color Constants (used inside this screen & dropdown) ---
  ...
  void _startTimer() {
    ...
    // If finished, reset to full duration first
  ...
  Widget build(BuildContext context) {
    final progress =
        _totalSeconds > 0 ? 1.0 - (_secondsRemaining / _totalSeconds): 1.0;
  ...
  width: 30,
  height: 30,
  color: Colors.white, // remove this line if your PNG already white
),
                          const SizedBox(height: 8),
                          Text(
                            "Upload your exercise image",
                            textAlign: TextAlign.center,
        ...
        Expanded(
          child: SizedBox(
            ...
            child: _TimerDropdown(
              ...
              options: const ["0 Min","5 Min","10 Min","15 Min","30 Min","60 Min"],
              onChanged: (v) {
                setState(() {
                  _selectedMinutes = v;
                  _updateTotalSeconds();
        ...
        child: Center(
          child: SizedBox(
            ...
            child: Stack(
              alignment: Alignment.center,
              children: [
                // Fixed - use CircularProgressIndicator with correct valueColor
                CircularProgressIndicator(
                  value: progress,
                  strokeWidth: 10,
                  valueColor: AlwaysStoppedAnimation<Color>(Color(0xFFFF8C42)),
                  backgroundColor: Color(0xFF1A4EBE),
                ),
                // Inner circle
                Container(
                  width: 70,
