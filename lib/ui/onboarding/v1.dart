...
class _V1PageState extends State<V1Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: AppBackground(child: _screens[_currentIndex]) , // Show current screen
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: const Color(0xFFFF9001), width: 3),
              ),
              child: Center(
                child: Image.asset(
    ...
    children: [
      ...
      Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [
              Color.fromRGBO(130, 150, 255, 0.09), // rgba(130,150,255,0.09)
        ...
        Row(
          ...
          children: [
            ...
            Container(
              ...
              child: Text("0/0, 0%", style: TextStyle(color: orange, fontSize: 12, fontWeight: FontWeight.w500)),
            ),
          ],
        ),
...
Widget _visionCard() {
  ...
  return Container(
    ...
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text("My Vision Board", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w600)),
        const SizedBox(height: 12),
        Row(
          children: [
            Expanded(
              child: _glossyButton(text: "Add Identity", gradient: const [orange, Color(0xFFFFB366)], onTap: () {}),
            ),
            const SizedBox(width: 8),
            Expanded(
              child: _glossyButton(text: "Add Dreams", gradient: const [blue, Color(0xFF64B5F6)], onTap: () {}),
            ),
          ],
        ),
      ],
...
Widget _glossyButton({required String text, required List<Color> gradient, required VoidCallback onTap}) {
  return InkWell(
    onTap: onTap,
    borderRadius: BorderRadius.circular(10),
    child: Container(
