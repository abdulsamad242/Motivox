...
import '../../widgets/inputs/simple_rounded_field.dart';

class GrowthAreaStepTwo extends StatelessWidget {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //------------------------------------------------------------------
                  // MICRO NICHE SECTION (PIXEL PERFECT)
                  //------------------------------------------------------------------
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                  ...
                  //------------------------------------------------------------------
                  // MICRO NICHE INPUT FIELD
                  //------------------------------------------------------------------
                  const SimpleRoundedField(
                    hint: "Ex : Helping Working Moms Stay Fit with Yoga",
