...
class _HomePageState extends State<HomePage> {
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: AppTypography.white70.copyWith(fontSize: 12),
              textAlign: TextAlign.center,
            ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        _goalCard(
                          "Pickup the laptop from service at 5:30 pm",
                          completed: false,
                        ),
                        _goalCard(
                          "Talk to wife to pick up child at 6:30 pm",
                          completed: false,
                        ),
                      ],
                    ),
  ...
  Widget _identityCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(20),
        gradient: const LinearGradient(
          colors: [Color(0xFFFF9001), Color(0xFFFFC567)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
      ),
  ...
  Widget _dreamLifeCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(20),
        gradient: const LinearGradient(
          colors: [Color(0xFF355CFF), Color(0xFF79A5FF)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
      ),
  ...
  Widget _emotionItem(String emoji, String label, int count) {
    final bool isSelected = count == 20;
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: AppTypography.white70.copyWith(fontSize: 14, height: 1.3),
            ),
